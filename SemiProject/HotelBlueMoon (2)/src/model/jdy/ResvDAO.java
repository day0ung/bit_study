...
//	update schedule set use = 0
//	where resvdate >= '2020-02-26' and resvdate < '2020-02-27'
//	and hotelseq = 1 and roomseq = 1
	public boolean addSchedule(String checkin, String checkout, int hotelSeq, int roomSeq) {
		...
		int count = 0;
		System.out.println("sql" + sql);
		System.out.println(checkin + checkout + hotelSeq + roomSeq);
