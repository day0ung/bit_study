...
ADD CONSTRAINT FK_SCHEDULE_SEQ0 FOREIGN KEY(HOTELSEQ)
REFERENCES HOTEL(SEQ);

ALTER TABLE SCHEDULE
ADD CONSTRAINT FK_SCHEDULE_SEQ1 FOREIGN KEY(ROOMSEQ)
REFERENCES ROOM(SEQ);
