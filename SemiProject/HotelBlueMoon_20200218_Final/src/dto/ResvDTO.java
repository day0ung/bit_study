...
public class ResvDTO {
	...
	//resvinfo
	public ResvDTO(int hotelSeq, int roomSeq,  String checkIn, String checkOut,
	...
	//SELECT RESVADDINFO
	public ResvDTO(int seq,int hotelSeq, int memberSeq, int roomSeq, String checkIn, String checkOut, int totalPrice,
			int current_guest) {
		super();
		this.hotelSeq = seq;
		this.hotelSeq = hotelSeq;
