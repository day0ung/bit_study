...
public class PollDto implements Serializable {
	//투표를 만든사람이 집어넣어줘야하는 항목
	private int pollid; //sequence 1 2 3 4 5
	private String id; // 투표 만든사람의 id -> admin
	private String question; //질문  -> 좋아하는 과일?
	private Date sdate; //투표시작일
	private Date edate; //투표종료일
	private int itemcount; // 보기의 갯수 -> 사과,배,귤
	private int polltotal; //이 항목의 투표한 사람 수
	private Date regdate; //질문 등록일
	
	//로그인한사람의 아이디가 투표를 했는지
