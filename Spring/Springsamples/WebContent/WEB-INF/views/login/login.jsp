			...
			<div id="login_wrap">
				<form action="loginAf.do" name="frmForm" id="_frmForm" method="post">
					...
					<tr>
						...
						<td>&nbsp;<input type="password" id="_pwd" name="pwd" data-msg="PassWord를 "
					...
					<tr>
						...
						<span>
							<a href="#none" id="_btnlogin" title="로그인">
								<img alt="X" src="./image/login_btn.jpg">
							</a>
							<a href="#none" id="_btnRegi" title="회원가입">
								<img alt="X" src="./image/regi.jpg">
							</a>
						</span>
					</tr>
					</tbody>
...
$("#chk_save_id").click(function (){
	if($("#chk_save_id").is(":checked")){ //check되었을때
		if($("#_userid").val().trim == ""){
			alert("아이디를입력해주세요");
			$("#chk_save_id").prop("checked", false); //체크박스 체크 풀어주기
		}else{
