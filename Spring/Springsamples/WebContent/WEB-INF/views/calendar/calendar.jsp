...
<thead style="padding: 10px;">
	...
	<tr height="40px">
		<td class="days2" colspan="7">
			...
			<%=pp %><%=p %>&nbsp;
			<span color="red" style="font-size: 24">
