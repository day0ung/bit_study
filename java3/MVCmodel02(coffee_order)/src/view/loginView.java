...
public class loginView extends JFrame implements ActionListener {
	...
	public loginView() {
		...
		pwTextF = new JPasswordField("aaa");
...
//		}
		...
		if(btn == logBtn) {
			//로그인버튼을 클릭했을때 멤버컨트롤러안에 loginaf 가 있음
			//뷰에서 입력된부분을 갖고 컨트롤러로 이동, 
			...
			//컨트롤러로 이동
			s.memCtrl.regi(); //controller의 regi함수호출-> account view나오게 함
			this.dispose();
		}
	}
